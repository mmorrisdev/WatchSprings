...
package copyright.markmorris.allrightsreserved.watchsprings.functions.upcoming
...
import kotlinx.android.synthetic.main.activity_upcomingitems.*
...
class UpcomingItemsActivity : ItemsActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_upcomingitems)

        currentTable = upcomingItemsTable
    }

    override fun onPostCreate(savedInstanceState: Bundle?) {
        super.onPostCreate(savedInstanceState)

        upcomingItemsTitle.text = "Upcoming Items"
        ...
        {
            upcomingItemsTitle.text = e.message
            return
        }
        ...
        for (i in 0..numRows)
        {
            var row = balloon.inflate(R.layout.item_table_row, upcomingIemsLayout, false)
            ...
            upcomingItemsTable.addView(row)
